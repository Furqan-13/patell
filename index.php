...
const SMTP_PASS = 'P@te||$13';
const SMTP_FROM = 'furqanpatel09@gmail.com';
const SMTP_FROM_NAME = 'Furqan Patel';
...
const CL_PIXEL_TRACKING_PREFIX = 'http://cvpatel.epizy.com/logger.php?v='; // change dir path accordingly
const CL_PATH_UNKNOWN = 'templates/cover_letter_unknown.html';
const CL_PATH_KNOWN = 'templates/cover_letter_known.html';
const CV_NAME = 'CV_Furqan_Patel.pdf';
const CV_PATH = 'CV_Furqan_Patel.pdf';
